        ...
        <section className="space-y-8">
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <div className="space-y-5 leading-relaxed text-justify text-gray-700">
              ...
              <p>SweetCake ra đời từ niềm đam mê thuần khiết với nghệ thuật làm bánh của chị Minh Ngọc – một người yêu thích ẩm thực và tin rằng mỗi chiếc bánh đều có thể kể một câu chuyện.</p>
              <p>Những ngày đầu tiên, chỉ là một góc nhỏ ở Quận 1, nhưng bằng tình yêu nghề và sự tận tụy, SweetCake dần trở thành điểm đến quen thuộc cho những ai yêu thích hương vị ngọt ngào, thủ công và tinh tế.</p>
              <p>Chúng tôi tin rằng bánh ngọt không chỉ là món ăn, mà còn là món quà chứa đựng niềm vui, sự sẻ chia, và cảm xúc trong từng lớp kem, từng chiếc bánh. Đó là lý do SweetCake luôn đặt trái tim và sáng tạo vào từng sản phẩm.</p>
