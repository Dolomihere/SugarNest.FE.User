...
const AccountPage = () => {
  ...
  const handleUpdateGender = async () => {
    try {
      const response = await AxiosInstance.patch("/users/gender", {
  ...
  const handleUpdatePhoneNumber = async () => {
    ...
    if (!/^(03|05|07|08|09)\d{8}$/.test(phone)) {
      setError(
        "Số điện thoại không hợp lệ. Vui lòng dùng các đầu số: 03, 05, 07, 08 hoặc 09."
      );
      return;
    }

    try {
      const response = await AxiosInstance.patch("/users/phone", {
        PhoneNumber: phone,
      });
      if (response.data.isSuccess) {
    ...
    <div className="min-h-dvh grid grid-rows-[auto_1fr_auto] font-sans bg-section text-main">
      ...
      <main className="w-full px-4 py-8 mx-auto space-y-6 max-w-7xl">
        <div className="p-6 bg-white border rounded-lg shadow-md">
          ...
          <section className="p-6 mb-8 bg-white border border-gray-200 shadow-sm rounded-2xl">
            <div className="flex flex-col items-center gap-8 md:flex-row md:items-start">
              ...
              <div className="relative group w-32 h-32">
                <img
                  ...
                  alt="avatar"
                  className="object-cover w-full h-full rounded-full border-4 border-amber-400 shadow-md transition-transform duration-300 group-hover:scale-105"
                />
                <div
              ...
              <div className="flex-1 w-full text-center lg:text-left">
                ...
                <div className="flex justify-center md:justify-start gap-4 text-amber-600 text-lg mt-2">
                  <FontAwesomeIcon
                    icon={faFacebook}
            ...
            <div className="mt-6 text-center md:text-right">
              <button
                ...
                className="inline-block px-5 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition"
              >
            ...
            {activeTab === "profile" && (
              <div className="grid gap-6 text-sm text-gray-800 sm:grid-cols-2">
                {[
                  ...
                  ({ label, key, icon, value, onChange, onSave, isSelect }) => (
                    <div
                      key={key}
              ...
              <div className="p-6 bg-white border rounded-xl shadow-md space-y-4">
                {favoritesLoading ? (
                  ...
                  <p className="text-red-500">
                    Lỗi khi tải sản phẩm yêu thích.
                  </p>
