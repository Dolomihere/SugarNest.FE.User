                      ...
                      navigate("/order-confirmation", {
                        state: {
                          ...
                          orderData: {
                            ...
                            recipientPhone: order.recipientPhone || order.phoneNumber,
                            note: order.note || null,
                            userVoucher: order.userVoucher || null,
                          ...
                          showSuccessMessage: order.paymentStatus === "success" ? "Đơn hàng đã được đặt thành công!" : null,
                          checkoutData: {
                            cartData: { cartItems: order.cartItems || [] },
                            selectedVoucher: order.userVoucher ? { voucherId: order.userVoucher } : null,
                            discount: order.discount || 0,
                            subtotal: order.subtotal || 0,
                            total: order.total || 0,
                            guestCartId: order.guestCartId || null,
                            form: {
