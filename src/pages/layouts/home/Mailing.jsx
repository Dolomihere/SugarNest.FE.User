...
export function Mailing() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const email = e.target.email.value; // lấy giá trị email từ input
    if (!email) return;
    // chuyển sang form đăng ký và kèm email
      ...
      <div className="max-w-4xl lg:my-10 mx-auto text-center lg:rounded-3xl bg-white p-10 shadow-xl border border-amber-200">
        <div>
          ...
          <p className="mb-8 text-lg text-stone-600">
            Đừng bỏ lỡ những chiếc bánh mới nhất cùng các ưu đãi hấp dẫn. 
